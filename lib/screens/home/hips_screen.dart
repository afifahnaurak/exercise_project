...
import 'package:exercise_project/screens/home/components/hips_body.dart';
import 'package:exercise_project/size_config.dart';

class HipsScreen extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          itemBuilder: (context, index){
            final HipsList hips = hipsList[index];
            return InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context){
                  return DetailsScreenHips(hips: hips);
                }));
              },
              child: Container(
                color: Colors.white,
