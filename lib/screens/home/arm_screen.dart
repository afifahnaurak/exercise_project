...
import 'package:exercise_project/screens/home/components/arm_body.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          itemBuilder: (context, index){
            final ArmList arm = armList[index];
            return InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context){
                  return DetailsScreenArm(arm: arm);
                }));
              },
              child: Container(
                color: Colors.white,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          flex: 1,
                          child: Image.asset(arm.imageSrc),
                        ),
                      ],
                    ),
                  ),
